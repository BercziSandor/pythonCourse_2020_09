...
# Annak szemléltetése, hogy a for ciklus először meghívja az objektum __iter__()
# metódusát és elkapja a StopIteration kivételt: Vegyük ki a megjegyzésből az
# __iter__() és a __next__() metódusokban a kiíratásokat.
