...
for par in (12, 6):
    try:
        ...
        print('Exceptiont kaptam, a típusa:', type(e), e)

# ValueErrort kaptam 12
# Exceptiont kaptam, a típusa: <class 'ValueError'> 6
...
# Exceptiont kaptam, a típusa: <class 'ValueError'> 12
# Exceptiont kaptam, a típusa: <class 'ValueError'> 6

# Az Exception mindenféle kivételt elkap, mert mindegyiknek ő az őse.
